...
function HomeScreen({ navigation }) {
  return (
      <View style={styles.container}>
          <Text style={styles.viewText}>Bienvenue</Text>
          <Button 
            title='Ada LOVELACE'
...
function ProfileScreen({ navigation }) {
  return (
    <View style={styles.profileView}>
        <Image resizeMode='contain' style={styles.viewImg} source={require("./assets/AdaByron.png")} />
        <Text style={{fontSize: 20, marginTop: 20}}>Ada LOVELACE</Text>
        <Button 
            title='Accueil'
  ...
  return (
    <ScrollView>
      <View style={styles.viewDesc}>
        <Text style={styles.descriptionText}>Ada Lovelace, de son nom complet Augusta Ada King, comtesse de Lovelace, née Ada Byron le 10 décembre 1815 à Londres et morte le 27     novembre 1852 à Marylebone dans la même ville, est une pionnière de la science informatique.
        </Text>
      </View>
    </ScrollView>
  )
...
function BiographieScreen() {
  return (
    <ScrollView>
      <View style={styles.viewDesc}>
        <Text style={styles.descriptionText}>Ada était la seule fille légitime du poète George Gordon Byron et de
...
function Root() {
  return (
    <Drawer.Navigator >
      <Drawer.Screen name="Accueil" component={HomeScreen} options={{ drawerItemStyle:{display: "none"}}} />
      <Drawer.Screen name="Ada LOVELACE" component={ProfileScreen} />
      <Drawer.Screen name="Personnage" component={DescriptionScreen} />
